...
//Load file from db verify if is production or local
...
//Config
    ...
    //Mongoose  
        ...
        mongoose.connect(db.mongoURI, {useNewUrlParser: true}) //db.mongoURI is from the db file in config folder
        .then(() => {
...
const PORT = process.env.PORT || 8081 //heroku port or 8081
